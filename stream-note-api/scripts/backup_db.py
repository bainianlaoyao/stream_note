...
def backup_database(
    *,
    ...
    if output is None:
        ...
        output = build_backup_path(sqlite_path, target_backup_dir, label="manual-backup")
...
def main() -> None:
    ...
    parser.add_argument("--backup-dir", help="Directory for generated backup files.", default=None)
    parser.add_argument("--output", help="Explicit output backup file path.", default=None)
